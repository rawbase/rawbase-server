...
//      }
      ...
      protected void finalize() throws Throwable
      {
		...
		/* (non-Javadoc)
		 * @see com.hp.hpl.jena.sparql.util.PrintSerializable#output(org.apache.jena.atlas.io.IndentedWriter, com.hp.hpl.jena.sparql.serializer.SerializationContext)
		 */
		public void output(IndentedWriter out, SerializationContext sCxt) {
