...
public class VirtuosoQueryExecution  implements QueryExecution
{
    ...
    public ResultSet execSelect()
    {
      ...
      try {
        ...
        java.sql.ResultSet rs = stmt.executeQuery(getVirtQueryString());
    ...
    protected String substBindings(String query) 
    {
      if (m_arg == null)
        return query;
    ...
    public Query getQuery() {
    	...
    	return QueryFactory.create(virt_query);
    }
	...
	protected void extractRow() throws Exception 
	{
	    ...
	    for(int i = 1; i <= rsmd.getColumnCount(); i++) {
	      ...
	      if (n != null)
	        ((BindingHashMap) v_row).add(Var.alloc(rsmd.getColumnLabel(i)), n);
	    }

	    if (virt_graph != null && !virt_graph.equals("virt:DEFAULT"))
	      ((BindingHashMap) v_row).add(Var.alloc("graph"), Node.createURI(virt_graph));
	  } 
	  catch(Exception e)
	  {
            throw new JenaException("ViruosoResultBindingsToJenaResults is FAILED.:"+e);
	...
	/* (non-Javadoc)
	 * @see com.hp.hpl.jena.query.QueryExecution#execConstructTriples()
	 */
	...
	/* (non-Javadoc)
	 * @see com.hp.hpl.jena.query.QueryExecution#execDescribeTriples()
	 */
	...
	/* (non-Javadoc)
	 * @see com.hp.hpl.jena.query.QueryExecution#getTimeout1()
	 */
	...
	/* (non-Javadoc)
	 * @see com.hp.hpl.jena.query.QueryExecution#getTimeout2()
	 */
